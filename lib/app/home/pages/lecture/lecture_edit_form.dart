...
class _LectureEditFormState extends State<LectureEditForm> {
  final logic = Get.find<LectureLogic>();
  ...
  void initState() {
    ...
    logic.uLectureName.value = widget.initialName;
    logic.uMajorId.value = widget.initialMajorId;
                  ...
                  SizedBox(
                    ...
                    child: SuggestionTextField(
                      ...
                      initialValue: ValueNotifier<Map<dynamic, dynamic>?>(
                          {
                            'code': widget.initialJobCode,
                            'name': widget.initialJobName,
                          }),
                      onSelected: (value) {
                        if (value.isEmpty) {
