...
class _EditMajorDialogState extends State<MajorEditForm> {
  ...
  void initState() {
    ...
    super.initState();
    logic.uMajorTitle.value = widget.initialTitle;
    logic.uMajorSelectedQuestionCate.value = widget.initialQuestionCate as String;
    logic.uMajorSelectedQuestionLevel.value = widget.initialQuestionLevel as String;
    logic.uMajorSelectedMajorId.value = widget.initialMajorId;
    logic.uMajorAnswer.value = widget.initialAnswer;
    logic.uMajorAuthor.value = widget.initialAuthor;
    logic.uMajorTag.value = widget.initialTag;
    logic.uMajorStatus.value = widget.initialStatus;
  }
                    ...
                    SizedBox(
                      ...
                      child: CascadingDropdownField(
                        ...
                        onChanged:
                          ...
                          logic.uMajorSelectedMajorId.value = level3.toString();
                          // 这里可以处理选择的 id
                        },
                      ),
                    ),
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: TextInputWidget(
                        ...
                        onTextChanged: (value) {
                          logic.uMajorAnswer.value = value;
                        },
                        validator:
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: TextInputWidget(
                        ...
                        onTextChanged: (value) {
                          logic.uMajorAuthor.value = value;
                        },
                        validator:
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: SingleSelectForm(
                        ...
                        onSelected: (item) =>
                            {logic.uMajorStatus.value = item['id']},
                      ),
                    ),
                  ],
                ),
